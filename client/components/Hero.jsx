...
export default function Hero(props) {
  return (
    <div className="w-full min-h-screen px-6 md:px-16 py-32 bg-[radial-gradient(ellipse_145.19%_190.18%_at_41.94%_148.97%,_rgba(56,_102,_65,_0)_0%,_rgba(30,_30,_30,_0.90)_100%)] bg-[url('/img/Hero.png')] bg-center bg-cover flex flex-col justify-center items-center text-center gap-6">
